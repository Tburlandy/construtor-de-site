        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 max-w-3xl mx-auto px-4">
            <div className="text-center animate-fade-in-up stagger-3">
              ...
              <div className="text-xs md:text-sm text-muted-foreground">Projetos instalados</div>
            </div>
            <div className="text-center animate-fade-in-up stagger-4">
              <div className="text-2xl md:text-3xl font-bold text-primary mb-1">25 anos</div>
              <div className="text-xs md:text-sm text-muted-foreground">de garantia nas placas</div>
            </div>
            <div className="text-center animate-fade-in-up stagger-5">
              <div className="text-2xl md:text-3xl font-bold text-primary mb-1">100%</div>
              <div className="text-xs md:text-sm text-muted-foreground">de satisfação no Google</div>
            </div>
            <div className="text-center animate-fade-in-up stagger-5">
              <div className="text-2xl md:text-3xl font-bold text-primary mb-1">6 anos</div>
              <div className="text-xs md:text-sm text-muted-foreground">No mercado</div>
            </div>
          </div>
        </div>
      </div>
