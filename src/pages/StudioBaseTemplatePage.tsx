...
import { BuilderClientSwitcher } from '@/components/studio-builder/BuilderClientSwitcher';
        ...
        <div className="mx-auto flex max-w-[1760px] flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex min-w-0 flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
            ...
            <BuilderClientSwitcher
              ...
              neutralLabel="Abrir construtor de um cliente"
              onSelect={(projectId) =>
                navigate(`/cliente/${encodeURIComponent(projectId)}`)
              }
              className="w-full min-w-[min(100%,260px)] sm:w-auto sm:min-w-[260px]"
            />
